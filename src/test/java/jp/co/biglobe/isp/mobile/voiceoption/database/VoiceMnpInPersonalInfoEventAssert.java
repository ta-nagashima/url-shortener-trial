...
public class VoiceMnpInPersonalInfoEventAssert {

    private static final String TABLE_NAME = "voice_mnp_in_personal_info_e";

    private DbUnitTester dbUnitTester;

    public VoiceMnpInPersonalInfoEventAssert(DbUnitTester dbUnitTester){
    ...
    public void assertTableNoCount() throws Exception{
        DatabaseAssert databaseAssert = new DatabaseAssert(dbUnitTester.getConnection());
        databaseAssert.assertTableNoCount(FixtureVoiceMnpInPersonalInfoEvent.Nothing.getDefaultData(), TABLE_NAME);
