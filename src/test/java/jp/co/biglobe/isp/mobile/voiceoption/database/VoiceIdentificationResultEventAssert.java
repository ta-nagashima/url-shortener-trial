...
public class VoiceIdentificationResultEventAssert {

    private static final String TABLE_NAME = "voice_identification_result_e";

    private DbUnitTester dbUnitTester;

    public VoiceIdentificationResultEventAssert(DbUnitTester dbUnitTester){
