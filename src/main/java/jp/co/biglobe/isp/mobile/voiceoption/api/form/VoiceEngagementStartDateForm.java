...
@EqualsAndHashCode
@AllArgsConstructor
public class VoiceEngagementStartDateForm implements FormToValueObject<VoiceEngagementStartDate> {
    ...
    @Override
    public VoiceEngagementStartDate getValueObject(){
        return new VoiceEngagementStartDate(value);
    }
}
