...
@Controller
public class BundleMnpOutWaitingCreateApi {
    ...
    @RequestMapping(value = "/voiceoption/inside/skip/testdata/bundle/mnpout/mnpoutwaiting/create", method = RequestMethod.POST)
    @ResponseBody
    public Map invoke(@Valid BundleMnpOutWaitingCreateRequest request, Errors errors) throws Exception {
