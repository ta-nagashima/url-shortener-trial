...
@EqualsAndHashCode
@AllArgsConstructor
public class VoiceEngagementCancelOrderDateForm implements FormToValueObject<VoiceEngagementCancelOrderDate> {
    ...
    @Override
    public VoiceEngagementCancelOrderDate getValueObject() {
        return new VoiceEngagementCancelOrderDate(value);
    }
}
