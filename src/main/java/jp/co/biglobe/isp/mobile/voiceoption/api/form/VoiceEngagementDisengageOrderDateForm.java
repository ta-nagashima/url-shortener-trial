...
@EqualsAndHashCode
@AllArgsConstructor
public class VoiceEngagementDisengageOrderDateForm implements FormToValueObject<VoiceEngagementDisengageOrderDate> {
    ...
    @Override
    public VoiceEngagementDisengageOrderDate getValueObject(){
        return new VoiceEngagementDisengageOrderDate(value);
    }
}
