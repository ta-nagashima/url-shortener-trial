...
@AllArgsConstructor
public class MnpOutRequestSendMailInput implements VoiceSendMailInput {
    ...
    private final MailTemplates mailTemplates = MailTemplates.BLTE_TELSIM_RECEPT_END_MNP;
