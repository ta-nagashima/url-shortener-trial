...
@Service
class VoiceEngagementApplyService {
    ...
    ValidVoiceEngagement newApply(VoiceEngagementInitialRequestData voiceEngagementInitialRequestData) {
        ...
        ValidVoiceEngagement validVoiceEngagement = voiceEngagementFactory.createForOrderAndJoin(voiceEngagementInitialRequestData);
