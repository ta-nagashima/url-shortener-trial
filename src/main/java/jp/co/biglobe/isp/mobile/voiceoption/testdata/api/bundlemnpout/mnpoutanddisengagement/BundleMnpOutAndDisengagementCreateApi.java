...
@Controller
public class BundleMnpOutAndDisengagementCreateApi {
    ...
    @RequestMapping(value = "/voiceoption/inside/skip/testdata/bundle/mnpout/mnpoutanddisengagement/create", method = RequestMethod.POST)
    @ResponseBody
    public Map invoke(@Valid BundleMnpOutAndDisengagementCreateRequest request, Errors errors) throws Exception {
