package jp.co.biglobe.isp.mobile.voiceoption.testdata.api.bundlemnpout.mnpreservationnumberwaiting;
...
@Controller
public class BundleMnpReservationNumberWaitingCreateApi {
    ...
    @RequestMapping(value = "/voiceoption/inside/skip/testdata/bundle/mnpout/mnpreservationnumberwaiting/create", method = RequestMethod.POST)
    @ResponseBody
    public Map invoke(@Valid BundleMnpReservationNumberWaitingCreateRequest request, Errors errors) throws Exception {
        ...
        return response.build(lteThreeGEngagementNumber.getApiValue());
    }
}
