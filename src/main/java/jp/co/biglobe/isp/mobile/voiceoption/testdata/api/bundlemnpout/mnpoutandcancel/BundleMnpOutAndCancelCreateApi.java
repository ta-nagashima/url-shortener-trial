...
@Controller
public class BundleMnpOutAndCancelCreateApi {
    ...
    @RequestMapping(value = "/voiceoption/inside/skip/testdata/bundle/mnpout/mnpoutandcancel/create", method = RequestMethod.POST)
    @ResponseBody
    public Map invoke(@Valid BundleMnpOutAndCancelCreateRequest request, Errors errors) throws Exception {
