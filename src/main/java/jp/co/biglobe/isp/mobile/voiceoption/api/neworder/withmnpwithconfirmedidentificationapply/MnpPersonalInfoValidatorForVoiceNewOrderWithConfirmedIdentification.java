...
@Component
public class MnpPersonalInfoValidatorForVoiceNewOrderWithConfirmedIdentification implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        return VoiceNewOrderWithMnpWithConfirmedIdentificationApplyRequest.class.equals(clazz);
    }

    @Override
    public void validate(Object target, Errors errors) {

        VoiceNewOrderWithMnpWithConfirmedIdentificationApplyRequest voiceNewOrderWithMnpApplyRequest = (VoiceNewOrderWithMnpWithConfirmedIdentificationApplyRequest)target;
    ...
    private boolean validatorUnnecessary(VoiceNewOrderWithMnpWithConfirmedIdentificationApplyRequest voiceNewOrderWithMnpApplyRequest,  Errors errors){
