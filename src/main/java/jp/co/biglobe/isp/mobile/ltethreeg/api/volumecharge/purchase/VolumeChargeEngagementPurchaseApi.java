...
@Controller
public class VolumeChargeEngagementPurchaseApi {
    ...
    @RequestMapping(value = "/lte3g/skip/option/volumecharge/engagement/purchase/submit", method = RequestMethod.POST)
    @ResponseBody
    public Map invoke(@Valid VolumeChargeEngagementPurchaseRequest request, Errors errors) {

        alarmValidationVerifier.verify(errors);

        volumeChargeEngagementPurchaseService.purchase(
                request.getLteThreeGEngagementNumberForm().getValueObject(),
                request.getVolumeChargePurchasedVolumeNumberForm().getValueObject());
