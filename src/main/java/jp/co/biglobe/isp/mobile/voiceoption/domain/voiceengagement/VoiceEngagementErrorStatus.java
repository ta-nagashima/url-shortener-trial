...
@AllArgsConstructor
public enum VoiceEngagementErrorStatus implements ErrorStatus, EnumConvertForApi {

    INVALID_STATUS(
            "契約状態が不正",
            VoiceEngagementErrorStatusApiValue.INVALID_STATUS
            );
    ...
    @Getter
    private final VoiceEngagementErrorStatusApiValue voiceEngagementErrorStatusApiValue;
    ...
    public String getApiValue(){
        return voiceEngagementErrorStatusApiValue.getNoRefactoringValue();
    }
     ...
     */
    @AllArgsConstructor
    private enum VoiceEngagementErrorStatusApiValue implements ApiValue {
