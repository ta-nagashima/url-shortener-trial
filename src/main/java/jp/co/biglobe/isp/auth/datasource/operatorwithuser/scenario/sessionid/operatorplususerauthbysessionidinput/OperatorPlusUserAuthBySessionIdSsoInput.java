...
@AllArgsConstructor
public class OperatorPlusUserAuthBySessionIdSsoInput implements OperatorPlusUserAuthBySessionIdInput {
    ...
    // 担当ID
    @Mapping("tantoid")
    private final OperatorId operatorId = new OperatorId("SSO");
    ...
    private final String tanto_sso_flg = "1";
    ...
    // 被操作者ID
    @Mapping("hi_sosaid")
    private  final UserId userId = new UserId("SSO");
