package jp.co.biglobe.lib.danger.validation.euc;
...
public class EucValidator implements ConstraintValidator<Euc, String> {

    @Override
    public void initialize(Euc required) {}
    ...
    public boolean isValid(final String beforeValue, ConstraintValidatorContext context) {
        ...
        // ASCII文字はエラーにする
        if (Pattern.compile("[\u0000-\u001F\u007F]").matcher(beforeValue).find()) {
            return false;
        }
