...
set time off
set termout off
spool old_macaddress_201310.log
...
AND HISTORY_SEQ IN (
	...
	AND  (CASE 
			...
			ELSE                                    A.ITEM_FREE52 
		END) BETWEEN '00000000000000' AND '20130930235959'
...
AND  (CASE 
		...
		ELSE                                ITEM_FREE52 
	END) BETWEEN '20131001000000' AND '20131031235959'
MINUS (
...
WHERE HISTORY_SEQ IN (
	...
	AND B.PRIMARY_KEY2 IN (
		...
		AND A.ITEM_FREE54 LIKE '20131101%'
	)
	AND  (CASE 
...
MINUS (
	...
	WHERE HISTORY_SEQ IN (
		...
		AND B.PRIMARY_KEY2 IN (
			...
			AND A.INDEX_FREE4 = '800'
			AND A.ITEM_FREE59 IS NOT NULL
			AND A.ITEM_FREE54 LIKE '20131001%'
		)
		AND  (CASE 
				WHEN B.ITEM_FREE54 IS NULL         THEN B.ITEM_FREE52 
				WHEN B.ITEM_FREE52 < B.ITEM_FREE54 THEN B.ITEM_FREE54 
