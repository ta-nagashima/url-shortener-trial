...
set time off
set termout off
spool old_macaddress_201401.log
...
AND HISTORY_SEQ IN (
	...
	AND  (CASE 
			...
			ELSE                                    A.ITEM_FREE52 
		END) BETWEEN '00000000000000' AND '20131231235959'
...
AND  (CASE 
		...
		ELSE                                ITEM_FREE52 
	END) BETWEEN '20140101000000' AND '20140131235959'
MINUS (
...
WHERE HISTORY_SEQ IN (
	...
	AND B.PRIMARY_KEY2 IN (
		...
		AND A.ITEM_FREE54 LIKE '20140201%'
	)
	AND  (CASE 
