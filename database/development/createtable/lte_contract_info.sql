 ...
 */
CREATE TABLE lte_contract_info (
  primary_key1 VARCHAR2(256) NOT NULL,
  index_free1 VARCHAR2(256),
  index_free_date4 TIMESTAMP, /* 2999-12-31 23:59:59 を H2 で保持するため、DATE ではなく TIMESTAMP にしておく */
  ...
  CONSTRAINT pk_lte_contract_info PRIMARY KEY(primary_key1)
)