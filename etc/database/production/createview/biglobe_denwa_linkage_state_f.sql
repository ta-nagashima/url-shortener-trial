CREATE OR REPLACE VIEW biglobe_denwa_linkage_state_f
AS
SELECT 1                                    AS record_id,
       linkage.msisdn                       AS primary_key1,
       CAST( '0' AS VARCHAR2( 256 ) )       AS primary_key2,
       CAST( '0' AS VARCHAR2( 256 ) )       AS primary_key3,
       CAST( '0' AS VARCHAR2( 256 ) )       AS primary_key4,
       null                                 AS foreign_key1,
       null                                 AS foreign_key2,
       null                                 AS foreign_key3,
       ...
       linkage.linkage_status               AS item_free1,
       linkage.notification                 AS item_free2,
       linkage.apply_channel                AS item_free3,
       null                                 AS item_free4,
       null                                 AS item_free5,
       null                                 AS item_free6,
       null                                 AS item_free7,
       ...
       null                                 AS update_id,
       linkage.update_date                  AS update_date,
       CAST( null AS DATE )                 AS delete_date
FROM biglobe_denwa_linkage_state linkage
;
